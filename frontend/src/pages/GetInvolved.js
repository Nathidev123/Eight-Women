    ...
    emailjs
      ...
      .then((response) => {
        ...
        setAlert({
          type: "success",
          message:
            "Your message has been sent. Thank you for reaching out. We will get back to you shortly",
        });
        setName("");
        setEmail("");
        setMessage("");
    ...
    <>
      <section className="ways-involved-section">
        <div className="ways-intro">
          ...
          <p>
            There are many ways to support Eight Women and contribute to the
        ...
        <div className="involvement-item involvement-left">
          ...
          <div className="involvement-content">
            ...
            <h2>Volunteer</h2>
            <p>
              Volunteers are at the heart of our work. Whether you can give a
              few hours, support us regularly, or contribute your skills to a
              specific project, your time and commitment make a meaningful
              difference.
            </p>
          </div>
        </div>
        ...
        <div className="involvement-item involvement-right">
          <div className="involvement-content">
            ...
            <p>
              Meaningful change is built through collaboration. By becoming a
              partner or sponsor, you help us expand our reach, strengthen our
              programmes, and create lasting opportunities for the communities
              we serve.
            </p>
          </div>
        ...
        <div className="involvement-item involvement-left">
          ...
          <div className="involvement-content">
            ...
            <p>
              Our events provide opportunities to learn, connect, and be part of
              meaningful conversations that inspire positive change. Your
              presence helps strengthen our collective voice.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="donate-container">
        <div className="donation-feature">
          <div className="donation-content">
            ...
            <p>
              Every donation, no matter the size, helps us continue our work and
              expand our impact. Your generosity supports our programmes,
              community initiatives, advocacy efforts, and opportunities for
      ...
      <section className="get-involved">
        <div className="involved">
          ...
          <p>
            Whether you'd like to volunteer, become a partner or sponsor, attend
            our events, or support our work through a donation, we'd be
            delighted to hear from you. Complete the form below, and we'll be in
            touch to discuss how you can become part of the Eight Women
        ...
        <div className="contact-details">
          ...
          <div className="contact-item">
            ...
            <div>
              ...
              <p>
                Second Floor Orange Drive, National Office, Block C,
                Braamfontein, Johannesburg 1756
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="email-form">
          <form onSubmit={handleSubmit} className="emailForm" id="emailForm">
            ...
            <p className="privacy-notice">
              ...
              provide may be processed by Eight Women to respond to your
              enquiry. Please see our{" "}
