      ...
      <div className="event-form-card">
        ...
        <form>
          <div className="form-header">
            ...
            <h1>Let's start with the organizer and event details.</h1>

            <p>
              This information helps attendees understand what your event is
              about.
            </p>
          </div>
          ...
          <div className="form-group">
            <textarea
              ...
              onChange={handleChange}
              className={
                emptyFields.includes("event_description") ? "error" : ""
              }
              rows={5}
            />
          </div>
