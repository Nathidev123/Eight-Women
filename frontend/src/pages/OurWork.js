  ...
  return (
    <>
      ...
      <section className="our-work-container">
        <div className="our-work-section">
          ...
          <div className="our-work-text reveal-right">
            ...
            <p>
              The Eight Women Initiative exists to challenge injustice, amplify
              unheard voices, and build a future rooted in equality, dignity,
              and peace. By bringing together experienced leaders, advocates,
              and changemakers, we work alongside communities to confront
              today's challenges while shaping a stronger, more inclusive South
      ...
      <section className="our-work-image reveal-scale">
        <img src={together} alt="Community members standing together" />
      </section>
      ...
      <section className="pillars-section">
        <div className="pillars-heading reveal">
          ...
          <p>
            Our work is guided by a commitment to justice, equality, peace, and
            community empowerment. These principles shape every initiative we
            undertake and every partnership we build.
          </p>
        </div>
        ...
        <div className="pillars-grid">
          <div className="pillar-div reveal">
            ...
            <p>
              Defending constitutional rights while protecting the dignity and
              safety of every person.
            </p>
          </div>
          ...
          <div className="pillar-div reveal">
            ...
            <p>
              Building safer communities by preventing violence and encouraging
          ...
          <div className="pillar-div reveal">
            ...
            <p>
              Addressing historical and social trauma to create lasting change.
            </p>
          </div>
          ...
          <div className="pillar-div reveal">
            ...
            <p>
              Encouraging communities to organize, speak out, and participate in
