      ...
      <div className="event-form-card">
        ...
        <form>
          <div className="form-header">
            ...
            <h1>Define your event's purpose and identity.</h1>

            <p>
              Let attendees know how they'll participate, who the event is for,
              and what your event represents.
            </p>
          </div>
          ...
          >
            ...
            <option value="Healing & Reconciliation">
              Healing & Reconciliation
            </option>
            <option value="Remembrance & Memorial">
