    ...
    <section className="who-we-are">
      <div className="who-content">
        <div className="who-text">
          ...
          <p>
            We are a collective of eight women united by a shared commitment to
            building peaceful, resilient and inclusive communities across South
            Africa. Through dialogue, education and community engagement, we
            work alongside citizens and leaders to transform conflict into
            opportunities for healing, justice and lasting social change.
          </p>
        </div>

        <div className="belief-timeline">
          {beliefs.map((belief) => (
            <div key={belief.number} className="belief-step">
